...
import com.hyperbrain.sopfc.infrastructure.adapter.common.dto.AppleGenericResponse;
import com.hyperbrain.sopfc.infrastructure.adapter.common.dto.AppleReminderCreateRequest;
import com.hyperbrain.sopfc.infrastructure.adapter.common.dto.AppleReminderUpdateRequest;
...
public class AppleSentinelSyncAdapter implements ExternalSyncPort {
    ...
    public void pushUpdate(CoreExecutable executable, String externalId) {
        log.info("📤 [APPLE-REMINDERS] Pushing update for ID: {}", externalId);
