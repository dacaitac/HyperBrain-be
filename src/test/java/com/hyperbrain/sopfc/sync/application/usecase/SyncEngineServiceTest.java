...
class SyncEngineServiceTest {
    ...
    void setUp() {
        ...
        syncEngineService = new SyncEngineService(List.of(externalPort), localRepo, syncMappingRepo, outboxPort);
    ...
    void shouldNotUpdateWhenChecksumIsSame() {
        ...
        String checksum = String.valueOf(java.util.Objects.hash(
                ...
                extItem.getStatus(),
                extItem.isPlanned(),
                extItem.getImpactScore(),
                extItem.getUrgencyScore(),
                extItem.getEstimatedMinutes(),
                extItem.getStartTime(),
                extItem.getEndTime(),
                extItem.getEnergyDrain(),
                extItem.getMentalLoad()
        ));
